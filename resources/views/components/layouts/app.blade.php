            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <button x-data="{ 
                        ...
                        class="p-2 rounded-lg bg-gray-100 dark:bg-gray-800 text-text-secondary hover:text-brand-teal transition-all duration-300 focus:outline-none border border-gray-200 dark:border-gray-700"

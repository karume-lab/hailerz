<div class="space-y-24 pb-24">
    ...
    <section class="relative pt-20 pb-16 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                <span
                    class="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase bg-primary-100 text-primary-700 mb-8">
                    Premium Talent Management
                </span>
                <h1
                    class="text-5xl md:text-7xl font-serif font-extrabold text-slate-950 tracking-tight mb-8 leading-[1.1]">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <a href="/talent"
                        class="w-full sm:w-auto px-8 py-4 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 transition-all shadow-xl shadow-primary-200 hover:-translate-y-0.5">
                        Browse Full Roster
                    </a>
                    <a href="/book"
                        class="w-full sm:w-auto px-8 py-4 bg-white text-slate-900 border border-slate-200 font-bold rounded-full hover:bg-slate-50 transition-all shadow-sm">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-end mb-12">
            ...
            <a href="/talent"
                class="hidden sm:flex items-center gap-2 text-sm font-bold text-primary-600 hover:text-primary-700 transition-colors group">
                View All Talent
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            @forelse($featuredTalent as $talent)
                <div
                    class="group bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-500 hover:-translate-y-1">
                    <div class="relative h-80 overflow-hidden">
                        ...
                        <div class="absolute top-4 right-4">
                            <span
                                class="px-3 py-1 bg-white/90 backdrop-blur text-[10px] font-black uppercase tracking-widest text-slate-900 rounded-full shadow-sm">
                    ...
                    <div class="p-8">
                        ...
                        <a href="/talent/{{ $talent->slug }}"
                            class="w-full inline-flex items-center justify-center px-6 py-3 border border-slate-200 rounded-2xl text-sm font-bold text-slate-900 group-hover:bg-primary-600 group-hover:text-white group-hover:border-primary-600 transition-all duration-300">
                            View Profile
                        </a>
                    </div>
                </div>
        ...
        <div class="bg-slate-900 rounded-[3rem] p-12 md:p-24 overflow-hidden relative">
            <div class="relative z-10 max-w-2xl">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="/book"
                        class="px-8 py-4 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 transition-all shadow-lg shadow-primary-900/40">
                        Get Started
                    </a>
                    <a href="/about"

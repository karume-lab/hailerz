<div class="py-24 bg-canvas min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-24 py-24 border-t border-border text-center">
            ...
            <a href="{{ route('booking.wizard') }}" class="inline-flex items-center justify-center px-10 py-5 bg-primary text-white font-black rounded-2xl hover:bg-primary-dark transition-all shadow-xl shadow-primary/20 hover:-translate-y-1">

  ...
  @else
   <div class="mb-16 text-center">
    <div class="flex items-center justify-center gap-3 mb-4">
     ...
     <span class="text-xs font-bold text-brand-primary uppercase tracking-widest">Formal Request</span>
     <span class="h-px w-8 bg-brand-primary"></span>
    </div>
   ...
   <div class="mb-16">
    <div class="relative">
     ...
     <div class="grid grid-cols-3 text-[10px] font-bold text-text-muted uppercase tracking-[0.2em]">
      ...
      <span class="{{ $currentStep >= 2 ? 'text-brand-primary' : '' }} text-center">Investment</span>

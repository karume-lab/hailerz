            ...
            <div class="mb-16">
                <div class="relative">
                    ...
                    <div class="grid grid-cols-3 text-[10px] font-bold text-text-muted uppercase tracking-[0.2em]">
                        <span class="{{ $currentStep >= 1 ? 'text-brand-teal' : '' }} text-left">Event Details</span>
                        <span class="{{ $currentStep >= 2 ? 'text-brand-teal' : '' }} text-center">Investment</span>
                        <span class="{{ $currentStep >= 3 ? 'text-brand-teal' : '' }} text-right">Contact</span>
                    </div>
                </div>
            </div>

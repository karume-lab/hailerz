    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-surface-light rounded-[2.5rem] p-10 sm:p-20 shadow-2xl border border-brand-primary/5">
            <div class="flex items-center gap-3 mb-8">
                ...
                <span class="text-xs font-bold text-brand-primary uppercase tracking-widest">The fine print</span>
            </div>
            <h1 class="text-4xl font-bold text-brand-primary mb-12 ">Terms of Service</h1>
            ...
            <div class="prose prose-lg max-w-none text-text-secondary font-light leading-relaxed">
                ...
                <h2 class="text-2xl font-bold text-brand-primary mt-12 mb-6 ">1. What we do</h2>
                ...
                <h2 class="text-2xl font-bold text-brand-primary mt-12 mb-6 ">4. Copyright & Content</h2>
                ...
                <p>These terms are governed by the laws of the State of New York, USA. Any legal issues that can't be resolved through talk will be handled in the appropriate courts located in New York County.</p>

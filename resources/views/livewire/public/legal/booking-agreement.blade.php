    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-surface-light rounded-[2.5rem] p-10 sm:p-20 shadow-2xl border border-brand-primary/5">
            <div class="flex items-center gap-3 mb-8">
                ...
                <span class="text-xs font-bold text-brand-primary uppercase tracking-widest">Legal & Policies</span>
            </div>
            <h1 class="text-4xl font-bold text-brand-primary mb-12 ">Standard Booking Agreement</h1>

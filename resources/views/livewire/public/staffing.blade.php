<div class="bg-surface-muted min-h-screen">
 ...
 <section class="relative bg-surface-dark py-32 lg:py-48 overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
   ...
   <h1 class="text-5xl md:text-8xl font-bold text-text-inverse tracking-tight mb-8 font-serif leading-tight">
    Elite <span class="text-brand-primary">Event</span> Staffing Solutions
   </h1>
  ...
  <div class="absolute inset-0 overflow-hidden">
   ...
   <div class="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-brand-secondary/10 rounded-full blur-[120px] opacity-10"></div>
  </div>
 </section>
   ...
   <div class="lg:grid lg:grid-cols-2 lg:gap-24 items-center">
    <div class="space-y-10">
     <div class="flex items-center gap-3">
      ...
      <span class="text-xs font-bold text-brand-primary uppercase tracking-widest">Global Standards</span>
     </div>
 ...
 <section class="py-32 bg-surface-dark relative overflow-hidden">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
   <div class="text-center max-w-3xl mx-auto mb-24">
    ...
    <p class="text-text-muted text-lg">A commitment to professional staffing that transcends typical labor solutions.</p>
   </div>

   <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
    <div class="flex gap-8">
     <div class="h-12 w-12 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary shrink-0">
      <span class="font-bold">01</span>
     </div>
     <div>
      <h3 class="text-2xl font-bold text-text-inverse mb-4 font-serif">Rigorous Vetting</h3>
      <p class="text-text-muted leading-relaxed font-light">Every staff member is interviewed, their credentials verified, and their track record for corporate event delivery audited.</p>
     </div>
    </div>
    <div class="flex gap-8">
     <div class="h-12 w-12 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary shrink-0">
     ...
     <div>
      ...
      <p class="text-text-muted leading-relaxed font-light">Our extensive network allows us to mobilize professional talent augmentation teams even on short notice across international territories.</p>
     </div>
    </div>
    <div class="flex gap-8">
     <div class="h-12 w-12 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary shrink-0">
     ...
     <div>
      ...
      <p class="text-text-muted leading-relaxed font-light">We don't just fill seats; we match professionals to your specific event culture, technical requirements, and client expectations.</p>
     </div>
    </div>
    <div class="flex gap-8">
     <div class="h-12 w-12 rounded-full bg-brand-primary/20 flex items-center justify-center text-brand-primary shrink-0">
     ...
     <div>
      ...
      <p class="text-text-muted leading-relaxed font-light">From travel and accommodation to payroll and compliance, Hailerz manages the full administrative lifecycle of your augmented team.</p>
     </div>
    </div>
   </div>
  </div>
 ...
 <section class="py-40 bg-surface-muted text-center relative overflow-hidden">
  <div class="max-w-4xl mx-auto px-4 relative z-10">
   <h2 class="text-4xl md:text-7xl font-bold text-text-primary mb-8 font-serif tracking-tight leading-tight">Scale Your <span class="text-brand-primary italic">Ambition</span>.</h2>
  ...
  <div class="absolute inset-0 opacity-5 bg-[radial-gradient(var(--color-brand-primary)_1px,transparent_1px)] bg-size-[40px_40px]"></div>
 </section>
</div>

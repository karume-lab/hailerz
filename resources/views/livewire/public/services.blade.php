<div class="bg-surface-muted min-h-screen">
    ...
    <section class="relative bg-surface-dark py-32 lg:py-48 overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div class="flex items-center justify-center gap-3 mb-8">
                ...
                <span class="text-xs font-bold text-brand-teal uppercase tracking-widest">Agency Solutions</span>
                <span class="h-px w-12 bg-brand-teal"></span>
            </div>
    ...
    <!-- Support Pillars -->
    <section class="py-32 bg-brand-navy relative overflow-hidden">

        ...
        @if($step === 1)
            <div class="space-y-8">
                <div>
                    ...
                    <input type="text" wire:model="client_name" placeholder="Legal entity or lead planner" class="w-full bg-surface-muted border border-brand-navy/10 rounded-xl px-5 py-4 text-text-primary focus:ring-2 focus:ring-brand-teal focus:border-transparent outline-none transition-all placeholder:text-text-muted">
                ...
                <div>
                    ...
                    <input type="date" wire:model="event_date" class="w-full bg-surface-muted border border-brand-navy/10 rounded-xl px-5 py-4 text-text-primary focus:ring-2 focus:ring-brand-teal focus:border-transparent outline-none transition-all">

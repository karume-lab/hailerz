...
return new class extends Migration
{
    ...
    public function up(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            // For MySQL / MariaDB and other engines, alter enum column natively
            DB::statement("ALTER TABLE talents MODIFY COLUMN status ENUM('draft', 'active', 'hidden', 'awaiting_agreement') NOT NULL DEFAULT 'draft'");
        }
    }
    ...
    public function down(): void
    {
        if (DB::getDriverName() === 'sqlite') {
            ...
            // Revert the status column enum on MySQL
            DB::statement("ALTER TABLE talents MODIFY COLUMN status ENUM('draft', 'active', 'hidden') NOT NULL DEFAULT 'draft'");
        }
    }
};

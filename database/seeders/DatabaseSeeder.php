...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $inquiries = [
            [
                'talent_id' => $djHero->id,
                'first_name' => 'TechGlobal',
                'last_name' => 'Summit 2026',
                ...
                'city' => 'Barcelona',
                'state' => 'Spain',
                'expected_guests' => 1500,
                'talent_category' => 'DJs',
                'budget_range' => '₦5,000 - ₦10,000',
                'additional_details' => 'Seeking a high-energy performance for our annual tech summit closing party in Barcelona. Expected attendance: 1,500 delegates.',
            ],
            [
                'talent_id' => $speakerHero->id,
                'first_name' => 'Future',
                'last_name' => 'Finance Forum',
                'email' => 'info@futurefinance.org',
                ...
                'state' => 'California',
                'expected_guests' => 500,
                'talent_category' => 'Speakers',
                'budget_range' => '₦10,000+',
                'additional_details' => 'We would like Marcus to open our Q3 forum with a 45-minute keynote on the impact of decentralized finance on traditional banking.',
            ],
            [
                'talent_id' => $bandHero->id,
                'first_name' => 'Luxury',
                'last_name' => 'Automotive Group',
                'email' => 'marketing@luxcars.de',
                ...
                'state' => 'Germany',
                'expected_guests' => 300,
                'talent_category' => 'Musicians',
                'budget_range' => '$5,000 - $10,000',
                'additional_details' => 'Looking for sophisticated live music for the unveiling of our new electric sedan. The atmosphere should be modern, sleek, and premium.',
            ],
        ];
